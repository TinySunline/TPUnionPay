...
Pod::Spec.new do |s|
  s.name             = 'TPUnionPay'
  s.version          = '0.1.0'
  s.summary          = 'A short description of TPUnionPay.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kingdomrain/TPUnionPay'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kingdomrain' => 'bygd2014@sina.com' }
  s.source           = { :git => 'https://github.com/kingdomrain/TPUnionPay.git', :tag => s.version.to_s }
